...
class CreatePostCubit extends Cubit<CreatePostState> {
  ...
  void submit() async {
    ...
    try {
      ...
      //our auth state has a user but it is a firebase user & our post model needs a author of
      // user model type so we create an empty user with uid as nothing else is needed.
      ...
      emit(state.copyWith(
        ...
        failure: const Failure(message: 'We are unable to create your post.'),
      ));
    }
  }
  ...
  void reset() {
    ...
    //to reset the screen after successful upload.
  }
}
